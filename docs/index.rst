...
The **extension-helpers** package includes
...
For a real-life example of how to implement extension-helpers in a project,
see the ``setup.py`` and ``setup.cfg`` files of the
`Affiliated package template <https://github.com/astropy/package-template>`_.

.. note:: extension-helpers v3.x requires Python 3.5 or later. If you wish to
          maintain Python 2 support for your package that uses extension-helpers,
          then do not upgrade extension-helpers to v3.0 or later. We will still
